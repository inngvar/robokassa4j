...
public abstract class RequestFactory {
	 ...
	 *            Id of invoice
	 * @param mrchLogin
	 *            Login of merchant in robocassa
	 * @param sum
	 *            Sum of the payment
	 * @param culture
	 ...
	 */
	public abstract RequestData create(int invoceId, String mrchLogin,
			String sum2, String culture, String currency, String description);
